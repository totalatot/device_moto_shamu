...
public class CMActionsSettings {
    ...
    private static final String GESTURE_WAVE_ALARM_KEY = "gesture_wave_alarm";
    ...
    public int getWaveAlarmAction() {
        return mWaveAlarmAction;
    }
    ...
    private void loadPreferences(SharedPreferences sharedPreferences) {
        ...
        mWaveAlarmAction = getIntPreference(sharedPreferences, GESTURE_WAVE_ALARM_KEY);
    }
    ...
    private SharedPreferences.OnSharedPreferenceChangeListener mPrefListener =
        ...
        public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
            ...
            if (GESTURE_USER_AWARE_DISPLAY_KEY.equals(key)) {
                mUserAwareDisplayEnabled = sharedPreferences.getBoolean(GESTURE_USER_AWARE_DISPLAY_KEY, true);
            ...
            } else if (GESTURE_WAVE_ALARM_KEY.equals(key)) {
                mWaveAlarmAction = getIntPreference(sharedPreferences, GESTURE_WAVE_ALARM_KEY);
            } else {
                updated = false;
            }
